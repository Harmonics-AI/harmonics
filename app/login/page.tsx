          ...
          <CardHeader className="space-y-6 pb-8">
            <div className="flex flex-col items-center space-y-4">
              ...
              <div className="text-center">
                <h1 className="text-2xl font-bold text-musicConnect-text-primary">Welcome back</h1>
                <p className="text-sm text-musicConnect-text-secondary mt-2">
                  Sign in to continue your music collaboration journey
                </p>
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-6">
            <form className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link 
                    ...
                    className="text-sm text-musicConnect-blue hover:text-musicConnect-green transition-colors"
                  >
                    Forgot password?
                  </Link>
                </div>
              ...
              <div className="flex items-center space-x-2">
                <Checkbox id="remember" className="border-musicConnect-border data-[state=checked]:bg-musicConnect-blue" />
                <Label htmlFor="remember" className="text-sm text-musicConnect-text-secondary">
            ...
            <div className="text-center text-sm">
              <span className="text-musicConnect-text-secondary">Don't have an account? </span>
              <Link href="/signup" className="text-musicConnect-blue hover:text-musicConnect-green transition-colors font-medium">
                Sign up
              </Link>
            </div>
